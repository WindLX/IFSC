...
if __name__ == "__main__":
    ...
    results = {"time": [], "cluster_num": [], "velocity": []}
    uav_num = 100
    ...
    sns.lineplot(x="time", y="cluster_num", hue="velocity", data=df)
    plt.xlabel("Time (s)")
    plt.ylabel("Cluster Number")
    plt.title("Cluster Number vs Time for Different Velocity")
    plt.legend(title="velocity")
    plt.savefig("./image/cluster_number_vs_time_for_velocity.png")
    plt.show()
